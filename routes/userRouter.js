...
//Shop Management
router.get("/shop",userAuth,cartItemCountMiddleware,shopController.getShopPage)
router.get("/productDetails",userAuth,cartItemCountMiddleware,shopController.getProductDetails)
router.get("/products",userAuth,cartItemCountMiddleware,shopController.sortProducts)
router.get("/categoryFilter",cartItemCountMiddleware,userAuth,shopController.categoryFilter)
router.get("/search",userAuth,cartItemCountMiddleware,shopController.searchProducts)
//Profile Management
